    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 col-sm-6 col-md-4">
                <img class="img-fluid" :src="producto.imagen" :alt="producto.id">
            </div>
            <div class="col-12 col-sm-6 col-md-8">
                ...
                <h5>Color</h5>
                <div>
                    <div class="color-box clic" v-for="color in producto.colores" :key="color" :style="{ backbroundColor:color }" @click="pickColor(color)">
                    </div>
                </div>
                <h5>Cantidad</h5>
                <div class="quantity">
                ...
                <div class="buy-box">
                    <button class="btn btn-primary" type="button" @click.once="comprar()" :disable="isDisabled">Comprar</button>
                </div>
            </div>
        </div>
